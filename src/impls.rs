#[cfg(portable_io_unstable_all)] // for unstable feature: vec writer (requires Rust nightly)
...
#[cfg(portable_io_unstable_all)] // unstable feature: vec writer (requires Rust nightly for allocator_api)
